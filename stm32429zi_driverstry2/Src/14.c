...
uint8_t rcv_buff[];
//some data
uint8_t TX_buff[]="no se que poner primo aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaawwwwwwwwwwwwwwwwwwwwwwwww";
uint8_t rxcomplt;
/*
 * PB6->SCL
 * PB9->SDA
